    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === 'success') location.assign('/login'); // location.assign(true);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Account created Successfully! Please check your email to verify your account');
              window.setTimeout(function () {
                location.assign('/');
              }, 3000);
            }
...
exports.deleteReview = exports.updateReview = exports.submitReview = void 0;
...
var submitReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(rating, review, tourId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            if (!_context.t0.response.data.message.includes('duplicate')) {
              _context.next = 11;
              break;
            }

            return _context.abrupt("return", (0, _alerts.showAlert)('error', 'You have already added a review!🙂'));
...
exports.deleteTour = exports.updateTour = void 0;
...
var updateTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId, summary) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var deleteTour = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(tourId) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (!res.data) {
              (0, _alerts.showAlert)('success', 'Tour deleted successfully!', 1);
              window.setTimeout(function () {
                return location.reload();
              }, 1000);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated Successfully!")); //   window.setTimeout(location.reload(true), 5000);
            }
...
var stripe = Stripe('pk_test_51JG1qXKUkCNFWE4OUbi2rA9M8qJfqOuCFRPdnTHNTUsVpOzdUPDkXWbznHWGG417sdG9Sl4dBjEECMvU7WjbkDAL00viRvassn');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"favorite.js":[function(require,module,exports) {
"use strict";
...
var addFavorite = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId, toggleBtn) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/users/favorite/".concat(tourId),
              data: {}
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alerts.showAlert)('success', 'Tour added to favorite');
            }
...
var removeFavorite = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(tourId, toggleBtn) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (!res.data) {
              (0, _alerts.showAlert)('success', 'Tour removed from favorite');
              toggleBtn.toggle('favorite-on');
            }
...
var reviewPage = document.getElementById('review__page'); // if (mapBox) {
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    form.append('photo', document.getElementById('photo').files[0]); // console.log(document.getElementById('photo').files);
    // console.log(form);
...
if (reviewForm) {
  reviewForm.addEventListener('submit', function (e) {
    ...
    var tourId = header.dataset.tourId;
...
if (reviewPage) {
  ...
  var review = document.querySelectorAll('#review'); // console.log({ rating, review });

  btnUpdate.forEach(function (btn, i) {
